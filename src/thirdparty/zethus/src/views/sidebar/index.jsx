...
class Sidebar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      rosEndpoint: localStorage.getItem('endpoint') || 'ws://127.0.0.1:9090',
    };
    ...
    return (
      <div id="sidebar">
        <div className="container">
          <img draggable={false} id="logo" src="https://raw.githubusercontent.com/rapyuta-robotics/zethus/devel/public/logo.svg" alt="Zethus" />
        </div>
